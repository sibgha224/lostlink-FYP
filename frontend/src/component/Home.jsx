    ...
    <div className="min-h-screen m-0 p-0" style={{ fontFamily: "'DM Sans', sans-serif", backgroundColor: '#F5F0F0' }}>
      ...
      <section className="px-[5%] pb-[70px]">
        <div className="flex justify-between items-center mb-9 flex-wrap gap-3">
          ...
          <button onClick={() => props.onGoToAllItems && props.onGoToAllItems()}
        ...
        {reportedItems.length === 0 ? (
          <div className="py-16 text-center bg-white rounded-2xl border border-[#e8d0d0]">
            <p className="text-[#c07080] font-medium">No items reported yet — be the first to post one!</p>
          </div>
        ) : (
