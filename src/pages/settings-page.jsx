    ...
    <div style={{ fontFamily: "'DM Sans', sans-serif", color: "#2e1a1a" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
        ...
        <div style={cardStyle}>
          ...
          <p style={sectionSub}>Manage your personal account details</p>

          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
            <div>
              <label style={labelStyle}>Full Name</label>
              <input className="settings-input" style={inputStyle} type="text" name="name" value={profile.name} onChange={handleProfileChange} />
            </div>
            <div>
              <label style={labelStyle}>Email Address</label>
              <input className="settings-input" style={inputStyle} type="email" name="email" value={profile.email} onChange={handleProfileChange} />
            </div>
            <div>
              <label style={labelStyle}>Phone Number</label>
              <input className="settings-input" style={inputStyle} type="text" name="phone" value={profile.phone} onChange={handleProfileChange} />
            </div>
            <div>
              <label style={labelStyle}>Role</label>
              <input style={{ ...inputStyle, background: "#fdf6f7", color: "#800020", fontWeight: 600 }} type="text" value={profile.role} disabled />
            </div>
          </div>
